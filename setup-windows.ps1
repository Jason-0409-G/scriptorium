...
$zipUrl = "https://github.com/Jason-0409-G/scriptorium/archive/refs/heads/main.zip"
Info "下载 research-to-paper ..."
try { Invoke-WebRequest -Uri $zipUrl -OutFile $zip -UseBasicParsing }
catch { Die "下载仓库失败(网络/GitHub 访问问题)。可挂代理后重试,或手动:git clone https://github.com/Jason-0409-G/scriptorium 然后运行其中的 install.ps1 -Target claude" }
